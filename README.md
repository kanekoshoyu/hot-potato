...
| "Did the quant agent see it? Is she on it? Did she finish?" | One `agent/status` call answers all three |
...
That's it. The bus now pre-registers a default roster (the pm agent, the quant agent, the data agent, the research agent, the infra agent, sho — the Daometric crew). Rename them or register your own agents (below).
