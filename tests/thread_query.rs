...
async fn thread_bus() -> (Arc<EventBus>, String, String, String) {
    ...
    for a in ["the pm agent", "the quant agent", "the data agent"] {
        store.register(a).await.unwrap();
    }
    let mut root = hot_potato::message::Message::new(
        "the pm agent", "the quant agent", hot_potato::message::MsgType::Task, "root", "b", None);
    ...
    let mut r1 = hot_potato::message::Message::new(
        "the quant agent", "the pm agent", hot_potato::message::MsgType::Reply, "re: root", "b", Some(root.id.clone()));
    ...
    let mut r2 = hot_potato::message::Message::new(
        "the pm agent", "the quant agent", hot_potato::message::MsgType::Reply, "re: re: root", "b", Some(r1.id.clone()));
    ...
    let mut stray = hot_potato::message::Message::new(
        "the data agent", "the pm agent", hot_potato::message::MsgType::Task, "unrelated", "b", None);
